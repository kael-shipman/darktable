...
static void pop_undo(dt_lib_module_t *self, dt_undo_type_t type, dt_undo_data_t *data)
{
  if(type == DT_UNDO_HISTORY)
  {
    ...
    const GList *current_params = darktable.develop->history;
...
static void _history_undo_data_free(dt_undo_data_t *data)
{
  dt_undo_history_t *hist = (dt_undo_history_t *)data;
